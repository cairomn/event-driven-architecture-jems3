		...
		},
    {
      ...
      allowedRoles: ['ROLE_ADMIN'],
			children: [
				...
				{ path: '/admin/instituicao/piso', title: 'Piso', type: 'link', allowedRoles: ['ROLE_ADMIN'] },
				{ path: '/admin/instituicao/sala', title: 'Sala', type: 'link', allowedRoles: ['ROLE_ADMIN'] },
			]
		},
		{
