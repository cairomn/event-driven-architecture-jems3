...
@Component({
  selector: 'cmdca-bookmark-header-admin',
  templateUrl: './bookmark-header-admin.component.html',
  styleUrls: ['./bookmark-header-admin.component.scss']
})
export class BookmarkHeaderAdminComponent implements OnInit {
  ...
  checkSearchResultEmpty(items: Array<any>) {
    if (!items.length) {
