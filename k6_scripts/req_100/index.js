...
export let HttpToMqttTimeRequest = new Trend('http_to_mqtt_time_request', true);
...
export const options = {
    scenarios: {
        analise_linear_100: {
            ...
            duration: '2.5s', // 10 iterações no total
...
export default function() {
    ...
    subscriber.addEventListener("message", (obj) => {
        ...
        let dt2 = new Date();
        var diffMiliSeconds = (dt2.getTime() - dt1.getTime());
        HttpToMqttTimeRequest.add(Math.abs(Math.round(diffMiliSeconds)));
    })
